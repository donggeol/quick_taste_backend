            ...
            response.on('end', function() {
                ...
                .on('response', function(response) {
                    ...
                    response.on('end', function() {
                        ...
                        if(tmpstart != -1) start = tmpstart;
                        start = _serverData.indexOf("<img",start+1);
                        console.log("<img> location of first image : " + start);
                        start = _serverData.indexOf("<img",start+1);
                        console.log("<img> location of second image : " + start);
                        start = _serverData.indexOf("<img",start+1);
                        console.log("<img> location of third image : " + start);
                        start = _serverData.indexOf("<img",start+1);
                        console.log("<img> location of fourth image : " + start);
                        start = _serverData.indexOf("<img",start+1);
                        console.log("<img> location of fifth image : " + start);
                        start = _serverData.indexOf("<img",start+1);
                        console.log("<img> location of image which I need: " + start);
                        var img_start = _serverData.indexOf("src", start);
                        console.log("start location of image : " + img_start);
                        var img_end = _serverData.indexOf("\"", img_start+5);
                        console.log("end location of image : " + img_end);
                        var id = _serverData.substring(img_start+5,img_end);
